    ...
    programs: [
        {
            ...
            courses: [
                { code: 'ARC1101', name: 'Design Studio I', credits: 5, category: 'Core Studio', semester: 1 },
                { code: 'ARC1102', name: 'Architectural Graphics', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'ARC1103', name: 'History of Architecture I', credits: 3, category: 'General', semester: 1 },
                { code: 'ARC1201', name: 'Design Studio II', credits: 5, category: 'Core Studio', semester: 2 },
                { code: 'ARC1202', name: 'Building Construction I', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'ARC1203', name: 'Environmental Science I', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'ARC2101', name: 'Design Studio III', credits: 6, category: 'Core Studio', semester: 3 },
                { code: 'ARC2102', name: 'Building Construction II', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'ARC2103', name: 'Structures I', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'ARC2201', name: 'Design Studio IV', credits: 6, category: 'Core Studio', semester: 4 },
                { code: 'ARC2202', name: 'Building Services I', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'ARC3101', name: 'Design Studio V', credits: 6, category: 'Core Studio', semester: 5 },
                { code: 'ARC3102', name: 'Theory of Architecture', credits: 3, category: 'General', semester: 5 },
                { code: 'ARC3201', name: 'Design Studio VI (Grad Project)', credits: 6, category: 'Core Studio', semester: 6 },
                { code: 'ARC3202', name: 'Professional Practice', credits: 3, category: 'General', semester: 6 }
            ]
        },
        {
            id: 'qs-b',
            ...
            courses: [
                { code: 'QSB1101', name: 'Measurement I (Substructure)', credits: 4, category: 'Core Tech', semester: 1 },
                { code: 'QSB1102', name: 'Construction Technology I', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'QSB1103', name: 'Principles of Law', credits: 3, category: 'General', semester: 1 },
                { code: 'QSB1201', name: 'Measurement II (Superstructure)', credits: 4, category: 'Core Tech', semester: 2 },
                { code: 'QSB1202', name: 'Building Services I', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'QSB1203', name: 'Economics of Construction', credits: 3, category: 'General', semester: 2 },
                { code: 'QSB2101', name: 'Measurement III (External Works)', credits: 4, category: 'Core Tech', semester: 3 },
                { code: 'QSB2102', name: 'Estimating I', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'QSB2103', name: 'Contract Administration I', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'QSB2201', name: 'Measurement IV (Civil Engineering)', credits: 4, category: 'Core Tech', semester: 4 },
                { code: 'QSB2202', name: 'Estimating II / Cost Planning', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'QSB3101', name: 'Dissertation / Research Project', credits: 6, category: 'Research', semester: 5 },
                { code: 'QSB3102', name: 'Industrial Training', credits: 8, category: 'Internship', semester: 5 },
                { code: 'QSB3201', name: 'Professional Practice & Ethics', credits: 3, category: 'General', semester: 6 }
            ]
        },
        {
            id: 'cm-b',
            ...
            creditsToGraduate: 120,
            courses: [
                { code: 'BCM1101', name: 'Construction Tech & Materials', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'BCM1102', name: 'Principles of Management', credits: 3, category: 'General', semester: 1 },
                { code: 'BCM1103', name: 'Structural Mechanics', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'BCM1201', name: 'Building Services & Systems', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'BCM1202', name: 'Construction Measurement', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'BCM2101', name: 'Project Planning & Scheduling', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'BCM2102', name: 'Site Management & Safety', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'BCM2103', name: 'Construction Law', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'BCM2201', name: 'Cost Estimation & Budgeting', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'BCM2202', name: 'Quality Management in Construction', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'BCM3101', name: 'Project Management Seminar', credits: 3, category: 'General', semester: 5 },
                { code: 'BCM3102', name: 'Research Project / Thesis', credits: 6, category: 'Research', semester: 5 },
                { code: 'BCM3103', name: 'Industrial Internship', credits: 8, category: 'Internship', semester: 5 },
                { code: 'BCM3201', name: 'Strategic Management & Finance', credits: 3, category: 'General', semester: 6 }
            ]
        },
        {
            id: 'arch-dip',
            ...
            courses: [
                { code: 'ARC1011', name: 'Design Studio I', credits: 5, category: 'Core Studio', semester: 1 },
                { code: 'ARC1012', name: 'Architectural Graphics', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'ARC1013', name: 'Introduction to Building Materials', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'ARC1021', name: 'Design Studio II', credits: 5, category: 'Core Studio', semester: 2 },
                { code: 'ARC1022', name: 'Building Construction I', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'ARC1023', name: 'History of Architecture', credits: 3, category: 'General', semester: 2 },
                { code: 'ARC2011', name: 'Design Studio III', credits: 6, category: 'Core Studio', semester: 3 },
                { code: 'ARC2012', name: 'Building Services', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'ARC2013', name: 'Computer-Aided Design (CAD)', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'ARC2021', name: 'Design Studio IV', credits: 6, category: 'Core Studio', semester: 4 },
                { code: 'ARC2022', name: 'Building Construction II', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'ARC2023', name: 'Measured Drawing', credits: 4, category: 'Core Studio', semester: 4 }
            ]
        },
        {
            id: 'la-dip',
            ...
            creditsToGraduate: 90,
            courses: [
                { code: 'LAD1011', name: 'Landscape Design Studio I', credits: 5, category: 'Core Studio', semester: 1 },
                { code: 'LAD1012', name: 'Landscape Graphic Communications', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'LAD1013', name: 'Introduction to Horticulture', credits: 3, category: 'Core Tech', semester: 1 },
                { code: 'LAD1021', name: 'Landscape Design Studio II', credits: 5, category: 'Core Studio', semester: 2 },
                { code: 'LAD1022', name: 'Planting Design I', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'LAD1023', name: 'Soil Science for Landscape', credits: 3, category: 'Core Tech', semester: 2 },
                { code: 'LAD2011', name: 'Landscape Design Studio III', credits: 6, category: 'Core Studio', semester: 3 },
                { code: 'LAD2012', name: 'Landscape Construction I', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'LAD2013', name: 'Plant Materials', credits: 3, category: 'Core Tech', semester: 3 },
                { code: 'LAD2021', name: 'Landscape Design Studio IV', credits: 6, category: 'Core Studio', semester: 4 },
                { code: 'LAD2022', name: 'Landscape Computer Graphics', credits: 3, category: 'Core Tech', semester: 4 },
                { code: 'LAD2023', name: 'History of Landscape Architecture', credits: 3, category: 'General', semester: 4 }
            ]
        }
    ],
